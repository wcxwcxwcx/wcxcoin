...
This means one can have an always-on wcxcoind instance running, and another local wcxcoind/wcxcoin-qt instance which connects to this node and receives blocks from it.
