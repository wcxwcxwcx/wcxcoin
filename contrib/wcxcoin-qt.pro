...
RESOURCES += src/qt/wcxcoin.qrc src/qt/wcxcoin_locale.qrc

TRANSLATIONS += src/qt/locale/wcxcoin_bg.ts \
                src/qt/locale/wcxcoin_de.ts \
                src/qt/locale/wcxcoin_en.ts \
                src/qt/locale/wcxcoin_es.ts \
                src/qt/locale/wcxcoin_fi.ts \
                src/qt/locale/wcxcoin_fr.ts \
                src/qt/locale/wcxcoin_it.ts \
                src/qt/locale/wcxcoin_ja.ts \
                src/qt/locale/wcxcoin_pl.ts \
                src/qt/locale/wcxcoin_pt.ts \
                src/qt/locale/wcxcoin_ru.ts \
                src/qt/locale/wcxcoin_sk.ts \
                src/qt/locale/wcxcoin_sv.ts \
                src/qt/locale/wcxcoin_vi.ts \
                src/qt/locale/wcxcoin_zh_CN.ts \
                src/qt/locale/wcxcoin_zh_TW.ts
