...
#   c) node1 mines 32 blocks, so now node 0 has 500000WCX, node 1 has 4250WCX, node2 has none.
#   d) node0 sends 601 WCX to node2, in two transactions (301 WCX, then 300 WCX).
