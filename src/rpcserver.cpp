...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WCXCOIN features */
        {"wcxcoin", "masternode", &masternode, true, true, false},
        {"wcxcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"wcxcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wcxcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wcxcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wcxcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"wcxcoin", "startmasternode", &startmasternode, true, true, false},
        {"wcxcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wcxcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wcxcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wcxcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wcxcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wcxcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wcxcoin", "mnbudget", &mnbudget, true, true, false},
        {"wcxcoin", "preparebudget", &preparebudget, true, true, false},
        {"wcxcoin", "submitbudget", &submitbudget, true, true, false},
        {"wcxcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wcxcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wcxcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wcxcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wcxcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wcxcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wcxcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wcxcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"wcxcoin", "mnsync", &mnsync, true, true, false},
        {"wcxcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> wcxcoin-cli " + methodname + " " + args + "\n";
}
