                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WCXCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WCX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wcxcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WCXCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about WCXCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WCXCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WCX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WCX addresses"));
    ...
    openAction->setStatusTip(tr("Open a wcxcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WCXCOIN Core help message to get a list with possible WCXCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WCXCOIN Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("WCXCOIN Core"); // default title
