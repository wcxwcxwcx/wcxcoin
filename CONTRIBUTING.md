Contributing to WCXCOIN Core
==================================

The WCXCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WCXCOIN Core project, and is not to be
confused with overall WCXCOIN Network Protocol consensus changes.

Whether a pull request is merged into WCXCOIN Core rests with the project merge
...
Patches that change WCXCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the WCXCOIN consensus, it must have been
...
The project leader is the release manager for each WCXCOIN Core release.
