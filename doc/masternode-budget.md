...
WCXCOIN now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<wcxcoin_address\> \<monthly_payment_wcxcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ WCX, _12_ times over the course of a year totaling _24000_ WCX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<wcxcoin_address\> \<monthly_payment_wcxcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` WCX.
 ...
 * vote-many          - Vote on a WCXCOIN initiative
 * vote-alias         - Vote on a WCXCOIN initiative
 * vote               - Vote on a WCXCOIN initiative/budget
