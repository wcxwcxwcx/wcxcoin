...
In order to support loading of multiple wallets in wcxcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wcxcoin.cpp.
...
Changes to wcxcoin.cpp
----------------------
wcxcoin.cpp is the entry point into wcxcoin-qt, and as such, will require some minor modifications to provide hooks for
