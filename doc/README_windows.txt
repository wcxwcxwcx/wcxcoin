...
Intro
-----
WCXCOIN (WCX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. WCXCOIN utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run wcxcoin-qt.exe.

WCXCOIN Core is the original WCXCOIN client and it builds the backbone of the network.
However, it downloads and stores the entire history of WCXCOIN transactions;
